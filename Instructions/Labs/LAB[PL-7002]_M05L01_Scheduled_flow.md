...
> **[Copilot]** を選択し、Copilot チャットで次のプロンプトを入力します: `Rename the trigger to Daily`。

### タスク 1.3 - 新しいタスクのクエリを実行する

1. トリガー ステップの下にある **+** アイコンを選択し、アクションを追加します。

1. 検索ボックスに、`list items` と入力します。
...
1. **[新しいタスク]** の下にある **+** アイコンを選択し、アクションを追加します。

1. 検索ボックスに、`Select` と入力します。
...
1. **[選択]** ステップの下にある **+** アイコンを選択し、アクションを追加します。

1. 検索ボックスに、`create html` と入力します。
...
1. **[HTML テーブルとして書式設定]** ステップの下にある **+** アイコンを選択し、アクションを追加します。
