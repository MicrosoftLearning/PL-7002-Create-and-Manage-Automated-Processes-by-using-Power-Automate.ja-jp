...
> **[Copilot]** を選択し、Copilot チャットで次のプロンプトを入力します: `Rename the trigger to New task`。
...
1. **[詳細を表示]** を選択し、**[アイテムへのリンク]** を選択します。

    ![承認アクションのステップのスクリーンショット。](../media/start-approval-action.png)

### タスク 1.4 - 条件を追加する

1. 承認トリガー ステップの下にある **+** アイコンを選択し、アクションを追加します。

1. 検索ボックスに、`condition` と入力します。
...
1. **[True]** の下にある **+** アイコンを選択して、アクションを追加します。

1. 検索ボックスに、`update item` と入力します。
...
1. **[False]** の下にある **+** アイコンを選択して、アクションを追加します。
...
1. 新しいブラウザー タブを開き、Power Automate ポータル (`https://make.powerautomate.com`) に移動します
